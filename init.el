...
(setq package-list '(async auctex auto-complete autopair clang-format cmake-ide
                           ...
                           sr-speedbar srefactor stickyfunc-enhance
                           company-math company-auctex))
...
(defun my-disable-semantic ()
  ...
  (setq company-backends (delete '(company-irony-c-headers
                                   company-irony
                                   company-semantic) company-backend))
  (add-to-list
   'company-backends '(company-irony-c-headers
                       company-irony))
  )
(defun my-enable-semantic ()
  ...
  (interactive)
  (setq company-backends (delete '(company-irony-c-headers
                                   company-irony) company-backends))
  (add-to-list
   'company-backends '(company-irony-c-headers
                       company-irony))
  )
...
;; Projectile for jumping
(projectile-global-mode)

;; Show unknown files in speedbar
...
(setq-default TeX-PDF-mode t); PDF mode (rather than DVI-mode)
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (helm-projectile projectile yasnippet writegood-mode window-numbering web-mode vlf solarized-theme markdown-mode magit hungry-delete helm-ls-hg helm-ls-git helm-flyspell helm-flycheck helm-ctest helm google-c-style flycheck-pyflakes flycheck-irony company-irony cmake-mode cmake-ide clang-format autopair auto-complete auctex async rtags flycheck company-irony-c-headers company-c-headers)))
 '(show-paren-mode t)
 '(tool-bar-mode nil))
